...
Let $B_L$ be a Borel subgroup of $G_K$, defined over a finite Galois extension $L/K$, $\uG_{\OL}$ be the base change of $\uG$ to $\OL$ and let $\uB$ be the schematic closure of $B_L$ in $\uG_{\OL}$.  Let $\uG^+$ be the $\OL$-subscheme of $\uG_{\OL}$ defined by Yu, modeling the kernel of reduction to the special fiber.
